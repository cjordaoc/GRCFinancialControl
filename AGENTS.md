...
Confirm .NET 8, restore dependencies, and ensure `dotnet build -c Release` passes with zero warnings.
...
- Behavior unchanged; documentation only when functionality changes.
