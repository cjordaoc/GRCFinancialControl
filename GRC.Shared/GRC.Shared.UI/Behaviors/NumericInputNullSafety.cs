...
namespace GRC.Shared.UI.Behaviors;

/// <summary>
/// Attached property that forces empty numeric inputs to zero on focus loss.
/// Prevents binding exceptions when users clear numeric fields.
/// </summary>
